...
- **Blob (Binary Large Object)**: This is the simplest object. It cannot point to other objects and it solely stores a sequence of bytes. It is the equivalent of a file in the file system. 
